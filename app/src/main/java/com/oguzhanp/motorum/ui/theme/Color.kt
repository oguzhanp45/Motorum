...
val Zemin = Color(0xFFF8FAFC)
val KartZemin = Color(0xFFFFFFFF)
val MetinAna = Color(0xFF0F172A)
val MetinIkincil = Color(0xFF64748B)
val MetinSolgun = Color(0xFF94A3B8)
val CizgiSolgun = Color(0xFFF1F5F9)
val SekmeZemin = Color(0xFFE2E8F0)
val MetinEtiket = Color(0xFF334155)

val AksesuarRenk = Color(0xFFA855F7)
val AksesuarZemin = Color(0xFFFAF5FF)
val AksesuarMetin = Color(0xFF7E22CE)

val RoadTripRenk = Color(0xFF14B8A6)
val RoadTripZemin = Color(0xFFF0FDFA)
val RoadTripMetin = Color(0xFF0F766E)

val BakimRenk = Color(0xFFF59E0B)
val BakimZemin = Color(0xFFFFFBEB)
val BakimMetin = Color(0xFFB45309)
